...
def get_table_download_link(df):
    """
    Generates a link alowing the data in a give pandas dataframe to be download
    in: dataframe
    out: href strin
    """
...
def main():
    ...
    if file:
        ...
        number = st.slider('Escolha o número de colunas que deseja ver', min_value=1, max_value=20)
